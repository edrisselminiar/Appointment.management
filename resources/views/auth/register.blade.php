<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- téléphone -->
        <div>
            <x-input-label for="téléphone" :value="__('Téléphone')" />
            <x-text-input id="téléphone" class="block mt-1 w-full" type="text" name="téléphone" :value="old('téléphone')" required autofocus autocomplete="téléphone" />
